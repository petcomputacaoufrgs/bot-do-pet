...
class Data:
    ...
    Members: dictJSON = field(default_factory=lambda: dictJSON("data/petianes.json", dumper=lambda o: o.to_json(), loader=lambda k, v: (int(k), Member.from_json(v))))
    Projects: dictJSON = field(default_factory=lambda: dictJSON("data/projects.json", dumper=lambda o: o.to_json(), loader=lambda k, v: (int(k), Project.from_json(v))))
