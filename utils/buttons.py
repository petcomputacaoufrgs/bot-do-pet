...
class KeyMenu(discord.ui.View):
    ...
    @discord.ui.button(label="Peguei", style=discord.ButtonStyle.green)
    ...
    @discord.ui.select(placeholder="Passei",options=users)
    ...
    @discord.ui.button(label="Devolvi", style=discord.ButtonStyle.red)
